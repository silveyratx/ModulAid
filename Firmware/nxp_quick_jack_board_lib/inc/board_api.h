...
/**
 * @brief		Initialize the LEDs on the NXP Quick_Jackboard
 * @param		None
 * @return	None
 */
...
/**
 * @brief		NXP Quick_Jack IO initial & detect the MIC&GND
 * @param		None
 * @return	None
 */
...
/**
 * @brief		NXP Quick_Jack initial
 * @param		None
 * @return	None
 */
void Board_QUICKJACK_Init(void);
